<template>
  <div>
    ...
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item>报销查询</el-breadcrumb-item>
    </el-breadcrumb>
    <!--卡片视图区-->
    <el-card>
      <!--搜索与添加区域-->
      <el-row :gutter="20">
        ...
        <el-col :span="6">
                <el-select @click.native="getusername()" v-model="xmbxForm.project_name" clearable placeholder="选择项目" filterable
      ...
      <el-table :data="baoxiaolist" border style="margin-top: 20px;"
        ...
        <el-table-column prop="cause" label="出差事由说明"></el-table-column>
